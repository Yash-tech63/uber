    ...
    return (
        <div>
            ...
            <div className=' flex justify-between items-center flex-col gap-2 '>
                ...
                <button onClick={() => (props.setVehicleFound(true), props.setConfirmRidepanel(false))} className='w-full mt-5 bg-green-600 text-white font-sm p-2 rounded-lg'>Confirm</button>
            </div>
